...
(function (factory) {
	...
	L.Control.Geocoder = L.Control.extend({
		...
		markGeocode: function(result) {
		    ...
		    if (this._geocodeMarkerc) {
		        this._map.removeLayer(this._geocodeMarkerc);
		    }

            this._geocodeMarkerc = new L.circle(result.center, $("#kmradius").val(), { "color": "red" })

		        //  .setRadius(3500)
		        // .bindPopup(result.html || result.name)
		        .addTo(this._map);
                //.openPopup()
             this._geocodeMarkerc.bringToBack();
