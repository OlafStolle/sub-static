...
/*
 Route360° JavaScript API v0.5.3 (a575c9e), a JS library for leaflet.js and google maps API. https://route360.net
...
r360.PolygonUtil = {
    ...
    /**
     * [clip clipping like sutherland https://rosettacode.org/wiki/Sutherland-Hodgman_polygon_clipping#JavaScript]
...
r360.SvgUtil = {
    ...
    getInverseSvgElement: function(gElements, options){
        ...
        var svgStart = "<div id=svg_"+ options.id + " style='" + r360.Util.getTranslation(options.offset) + ";''><svg"  +
                            ...
                            " style='fill:" + options.backgroundColor + " ; opacity: "+ options.backgroundOpacity + "; stroke-width: " + options.strokeWidth + "; stroke-linejoin:round; stroke-linecap:round; fill-rule: evenodd' xmlns='https://www.w3.org/2000/svg'>"
        var svgEnd   = "</svg></div>";
    ...
    getNormalSvgElement: function(gElements, options){
        ...
        var svgStart = "<div id=svg_"+ options.id + " style='" + r360.Util.getTranslation(options.offset) + ";''><svg "  +
                            " height=" + options.svgHeight +
                            " width="  + options.svgWidth  +
                            " style='fill:" + options.backgroundColor + " ; opacity: " + options.opacity + "; stroke-linejoin:round; stroke-linecap:round; fill-rule: evenodd' xmlns='https://www.w3.org/2000/svg'>"
        var svgEnd   = "</svg></div>";
...
r360.Util = {
    ...
    //https://pordlabs.ucsd.edu/matlab/coord.htm
...
r360.TravelOptions = function(){
    ...
    /**
    * @description Set the buffer to apply to the polygons. Buffer is in units as defined by the srid. For WGS84 (lat/long, srid: 4326) the unit is degrees. The length of a degree varies depending on location, and specifically for longitute, which converges at the poles. You may want to [calculate](https://msi.nga.mil/MSISiteContent/StaticFiles/Calculators/degree.html) the buffer in degrees based on location, if using WGS84.
    * For
    *
