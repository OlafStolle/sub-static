...
Provides Beautiful Animated Marker Clustering functionality for [Leaflet](https://leafletjs.com), a JS library for interactive maps.
...
The [realworld example](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-realworld.388.html) is a good place to start, it uses all of the defaults of the clusterer.
Or check out the [custom example](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-custom.html) for how to customise the behaviour and appearance of the clusterer
...
* **spiderLegPolylineOptions**: Allows you to specify [PolylineOptions](https://leafletjs.com/reference.html#polyline-options) to style spider legs. By default, they are "{ weight: 1.5, color: '#222' }".
...
"""
Check out the [custom example](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-custom.html) for an example of this.
...
* **disableClusteringAtZoom**: If set, at this zoom level and below markers will not be clustered. This defaults to disabled. [See Example](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-realworld-maxzoom.388.html)
...
See [example/marker-clustering-convexhull.html](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-convexhull.html) for a working example.
"""javascript
markers.on('clusterclick', function (a) {
...
See [marker-clustering-zoomtobounds.html](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-zoomtobounds.html) for a working example.
"""javascript
markers.on('clusterclick', function (a) {
...
[realworld 10000 example](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-realworld.10000.html)
[realworld 50000 example](https://leaflet.github.com/Leaflet.markercluster/example/marker-clustering-realworld.50000.html)
